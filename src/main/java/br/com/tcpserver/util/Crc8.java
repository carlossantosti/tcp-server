...
/**
 * Esta classe foi mantida para posteriormente encontrar o erro no cálculo.
 * Por hora não há utilidade no sistema, mas o problema no cáculo do CRC foi contornado com a Crc8Api.java
 * 
